...
export class Search {
  searchInputElement() {
    return element(
      by.css(".header__search app-predictive-search input.form-control")
    );
  }

  typeaheadContainer() {
    return element(by.css(".header__search typeahead-container"));
  }

  firstResult() {
    return element(by.css(".header__search typeahead-container li.active"));
  }
