const data = {
  "DATA": {
    ...
    "TWEET_ONE_FEATURE_PER_DAY": "{{place1}} had {{units}} {{action}} per day in {{year}}. That's {{total}} total {{action}}, or {{rate}}% of renter homes. Find eviction rates for your area at {{link}}",
    "TWEET_ONE_FEATURE": "{{place1}} had {{total}} {{action}} in {{year}}. That's {{rate}}% of renter homes, or {{perDay}} per day. Find eviction rates for your area at {{link}}",
    "TWEET_TWO_FEATURES": "{{place1}} {{action}} {{rate}}% of renter homes in {{year}}, more than {{place2}}. Find eviction rates for your area at {{link}}",
    "TWEET_THREE_FEATURES": "{{place1}} {{action}} {{rate}}% of renter homes in {{year}}, more than {{place2}} and {{place3}}. Find eviction rates for your area at {{link}}",
  ...
  "MAP": {
    ...
    "FLAG_LOW": "This area's estimated eviction/filing rate is too low. Please see our FAQ section to better understand why."
  },
  "NAV": {
    "HOME": "Home",
    "MAP": "Map & Data",
    ...
    "DATA_MERGE": "Data Merge Application",
  ...
  "RANKINGS": {
    ...
    "LIST_INTRO": "View {{year}} eviction rankings for locations across America. Scroll through the list or use the search bar to find a place. To refine your results, choose an area type and a data type. You can also search within states using the Region menu.",
    ...
    "SHARE_AVERAGE": "an average of {{amount}}% of",
    "SHARE_PERCENT_OF": "{{amount}}% of",
    "SHARE_HAD_COUNT": "had the most",
    "SHARE_HAD_RATE": "had the highest rate",
    "SHARE_TOTAL": "total",
    "SHARE_RATE": "rate",
  ...
  "FOOTER": {
    ...
    "COPYRIGHT": "<p>All content &copy; 2018 Eviction Lab. All rights reserved.</p><p>Map made possible by Mapbox</p>",
