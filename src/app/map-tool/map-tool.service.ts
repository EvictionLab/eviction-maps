...
export class MapToolService {
  ...
  lowFlags = {
    'er': [
      '15', '24', '50', '56', '06', '09', '53', '33', '34',
      '11', '36', '22', '04', '21', '16', '47', '48'
    ],
    'efr': [
      '15', '50', '56', '06', '09', '53', '33', '34',
      '11', '36', '22', '04', '21', '16', '47', '48'
    ]
  };
  ...
  setLocations(locations) {
    locations.forEach(l => {
      this.dataService.getTileData(l.geoid, l.lonLat, true)
